...
/**
* \mainpage The Official MatchMaker App Documentation 
*
* \section intro_sec App Description
*
* This project's goal is to match users of a social/dating app based on their selected hobbies, using several algorithms involving probabilities.
*
* \section install_sec Running
*
* <b><U>Simply run appConjunta.java</U></b> <br>
